...
Im folgenden Abschnitt wollen wir die sozialen Aspekte und Probleme betrachten, die kollaboratives Design mit sich bringt.
...
Im letzten Kapitel haben wir den Begriff >>Kollaboratives Design<< erörtert und eine Definition geliefert. Wir haben gesehen, dass es sich dabei um eine weitaus komplexere Aktivität handelt, als einfach eine gewisse Arbeitsaufgabe in einer Gruppe zu lösen. Darauf aufbauend haben wir die sozialen Eigenheiten von kollaborativem Design abgehandelt. Aus diesem Abschnitt geht klar hervor, dass soziale Prozesse in einer solchen Gruppe von unterschiedlichen Personen höchst kompliziert sein können. Anhand zweier diverser Identitäten haben wir diese Tatsache erläutert und vertieft. Schlussendlich haben wir im letzten Abschnitt die Analyse eines kollaborativen Designmeetings präsentiert und die sozialen Aspekte der Kollaboration dadurch praxisnahe aufbereitet.
