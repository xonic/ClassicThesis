...
\emph{Anmerkung: \graffito{\(\clubsuit\)} Es folgen verschiedene asynchrone kollaborative Systeme, die nicht unbedingt mit Skizzieren in Verbindung gebracht werden, aber das Prinzip von CSCW veranschaulichen.}

\subsection{Synchrone Groupware}

\emph{Anmerkung: \graffito{\(\clubsuit\)} Es folgen verschiedene synchrone kollaborative Systeme, die nicht unbedingt mit Skizzieren in Verbindung gebracht werden, aber das Prinzip von CSCW veranschaulichen.}

\subsection{Multisynchrone Groupware}

\emph{Anmerkung: \graffito{\(\clubsuit\)} Es folgen verschiedene multisynchrone kollaborative Systeme, die nicht unbedingt mit Skizzieren in Verbindung gebracht werden, aber das Prinzip von CSCW veranschaulichen.}
