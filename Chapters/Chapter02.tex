...
\medskip Das folgende Kapitel soll anhand von Beispielen und Projekten aus der Literatur zeigen, durch welche Methoden Meetings bzw. im speziellen Designsessions unterstützt werden können. Besonderes Augenmerk soll dabei auf das Skizzieren als Designmethode und kooperatives Arbeiten in CSCW\footnote{Computer Supported Cooperative Work} Umgebungen liegen.
...
\medskip Die Schreibunterlage spielt im Prozess der Ideenentwicklung, neben der des Festhaltens von Informationen und der Vermittlung von Ideen, eine aktive Rolle. Die Unterstützung dieses Prozesses (z.B. durch elektronische Hilfsmittel) ist aber alles andere als unproblematisch, wie beispielsweise die Frustrationen von Designer beweisen, die versuchen konventionelle CAD Tools für die Weiterentwicklung von Ideen - von konzeptionellen Skizzen zu formellen Spezifikationen - zu verwenden. Dieser Aspekt zeigt die Verwendung der Schreibunterlage als Teil eines interaktiven Prozesses, anstatt der Reduzierung dessen auf ein Text-Grafik Artefakt. 
...
Über die Jahre wurden einige Versuche gestartet, diesem Wunsch mit Hilfe von elektronischen Mitteln nachzukommen. Im folgenden wollen wir nun einige davon beschreiben.
...
Unglücklicherweise zeigten die Tests auch, dass ein mausbasiertes System für interaktive Skizziersessions nicht ideal ist. Ein ideales Interface für diese Art von Programm wäre laut Lee ein gut integriertes Grafiktablett in Verbindung mit einem Flatscreen. Das wäre die bestmögliche Annäherung zu einer Technologie, die Stift und Papier ersetzen könnte.
...
\begin{figure}
		...
		\caption[Repräsentationen der Strichstatistik \newline \citep{BasteaForte:2007}]{Darstellung der Strichhäufigkeit zweier Gruppen. Die Ergebnisse der Experimentalgruppe (oben) zeigen deren Interaktivität beim Skizzieren. Im Gegensatz die Kontrollgruppe (unten), mit nur einzelnen Wechsel zwischen den Teilnehmern.}\label{fig:basteaEvaluationStrokes}
\end{figure}
...
In diesem Kapitel haben wir verschiedene ältere und jüngere Systeme vorgestellt, die Personen bei ihrer Zusammenarbeit innerhalb einer Gruppe unterstützen. Darunter einige relativ simple Anwendungen, beispielsweise \emph{X-Sketch} und \emph{ScreenCrayons}, die auf normalen Rechnern laufen, als auch sehr anspruchsvolle Systeme wie \emph{Roomware}. Dieses vereint mehrere hardware- und softwarebasierte Lösungen und schafft so einen kompletten elektronischen Meetingraum. Dadurch haben wir einen Überblick über den aktuellen Stand der Wissenschaft bekommen und eine Grundlage für die weitere Fortführung der Arbeit, als auch für die Konzeption und Umsetzung unserer kollaborativen Annotationssoftware \emph{Scribbler}, geschaffen.
