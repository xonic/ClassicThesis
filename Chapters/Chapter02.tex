...
\begin{figure}[bth]
	...
	\subfloat[\emph{Multi-user ClearBoard mit MiniNavigator}]{
		\includegraphics[width=.4\linewidth]{gfx/wangClearBoardConcept.png}
	} 
	\quad
	\subfloat[\emph{3D-Navigator}]{
		\includegraphics[width=.5\linewidth]{gfx/wang3DNavigatorConcept.png}
	}
	\quad
	\subfloat[\emph{ConverTable}]{
		\includegraphics[width=.9\linewidth]{gfx/wangConverTableConcept.png}
	}
	\quad
	\subfloat[\emph{More is more}]{
		\includegraphics[width=.9\linewidth]{gfx/wangMoreIsMoreConcept.png}
	}
