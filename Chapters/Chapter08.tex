...
\scribbler fängt sog. globale und lokale Eingabe-\emph{Events} ab. \emph{Events} sind vom Benutzer hervorgerufene Aktionen, die an Eingabegeräten vorgenommen wurden. So ist ein Druck auf die linke Maustaste beispielsweise ein \emph{LeftMouseDownEvent}, oder das Halten einer Taste auf der Tastatur ein \emph{KeyDownEvent}. Auf die selbe Weise erkennt das System ein \emph{TabletProximityEvent}.  Betriebssystem bedingte Aktionen  Voraussetzung ist, dass der Zeichenmodus aktiv ist.
