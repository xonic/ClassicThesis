...
Durch die \emph{Accessibility} Funktion von \emph{Mac OS X} (vgl. \ref{sec:programmLogik} \nameref{sec:programmLogik}) hatten wir ein universelles Medium, um auf beliebigen Content zu zeichnen. Somit konnten wir ein universelles Annotierungsprogramm entwickeln. \\ 
