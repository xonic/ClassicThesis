...
Durch die \emph{Accessibility} Funktion von \emph{Mac OS X} (vgl. \ref{sec:technik} \nameref{sec:technik}) hatten wir ein universelles Medium, um auf beliebigen Content zu zeichnen. Somit konnten wir ein universelles Annotierungsprogramm entwickeln. \\ 
